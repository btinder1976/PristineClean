...
const reviews = [
  ['Beautiful attention to detail', 'The goal is for every customer to feel like the home is lighter, calmer, and easier to enjoy.'],
  ['Warm and reliable service', 'Pristine Clean is built around hospitality, communication, and respect for the home.'],
  ['Easy to request online', 'The site is becoming a simple customer-friendly booking experience with payments and reminders.']
]

const faqs = [
  ['Where do you clean?', 'Pristine Clean is starting in Sacramento and nearby areas including Orangevale, Citrus Heights, Roseville, and Folsom as availability grows.'],
  ['Can I book online?', 'Yes. Use the Book tab to send a cleaning request. We follow up to confirm timing, scope, and pricing.'],
  ['Can customers pay online?', 'Stripe is connected for Phase 1 payment testing. Booking deposits and invoices can be added next.'],
  ['Do you offer recurring service?', 'Yes. Weekly, biweekly, and monthly recurring cleaning can be requested.']
]
